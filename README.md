...
> `ORM`框架，支持数据库：`MySQL`、`SQL Server`、`Oracle`、`SQLite`、`MS Access`、`Firebird`、`PostgreSql`、`DB2`、`Informix`、`ClickHouse`
...
<configuration>
	...
	<dbProviderMap>
		<databases>
			<!-- Supports configuring any database that implements the DbProviderFactory class. -->
