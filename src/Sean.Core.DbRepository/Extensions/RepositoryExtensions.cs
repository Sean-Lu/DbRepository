...
public static class RepositoryExtensions
{
    ...
    #region SqlCommand
    public static ISqlCommand GetSqlForAdd<TEntity>(this IBaseRepository repository, TEntity entity, bool returnAutoIncrementId = false, Expression<Func<TEntity, object>> fieldExpression = null, PropertyInfo outputPropertyInfo = null)
    {
        ...
        return repository.CreateInsertableBuilder<TEntity>(fieldExpression == null)
            ...
            .OutputParameterIF(returnAutoIncrementId && outputPropertyInfo != null, entity, outputPropertyInfo)
            .SetParameter(entity)
            .Build();
    }
