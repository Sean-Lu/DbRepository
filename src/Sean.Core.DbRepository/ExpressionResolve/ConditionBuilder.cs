...
namespace Sean.Core.DbRepository
{
    internal static class ConditionBuilder
    {
        ...
        public static StringBuilder BuildLikeOrEqualCondition(ParameterExpression parameterExpression, MethodCallExpression methodCallExpression, WhereClauseAdhesive adhesive, bool notEquals = false)
        {
