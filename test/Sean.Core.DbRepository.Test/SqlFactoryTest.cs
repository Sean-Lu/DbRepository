...
(@UserId_2, @UserName_2, @Age_2, @Sex_2, @PhoneNumber_2, @Email_2, @IsVip_2, @IsBlack_2, @Country_2, @AccountBalance_2, @AccountBalance2_2, @Status_2, @Remark_2, @CreateTime_2, @UpdateTime_2)");
        ...
        {
            var testEntity = new TestEntity { Id = 1 };
            ISqlCommand sqlCommand = SqlFactory.CreateUpdateableBuilder<TestEntity>(DatabaseType.MySql, true)
                .Where(entity => entity.Status == 1 && entity.IsVip && entity.Age > 18)
                .SetParameter(testEntity)
                .SetSqlIndented(true)
                .Build();
            ...
            ISqlCommand sqlCommand2 = SqlFactory.CreateUpdateableBuilder<TestEntity>(DatabaseType.MySql, false)
        ...
        {
            ISqlCommand sqlCommand = SqlFactory.CreateQueryableBuilder<TestEntity>(DatabaseType.MySql, false)
        ...
        public void TestSelectWhereIF()
        {
            ...
            ISqlCommand sqlCommand2 = SqlFactory.CreateQueryableBuilder<TestEntity>(DatabaseType.MySql, false)
                .SelectFields(entity => entity.UserId)
                .Where(entity => entity.Status == 1)
