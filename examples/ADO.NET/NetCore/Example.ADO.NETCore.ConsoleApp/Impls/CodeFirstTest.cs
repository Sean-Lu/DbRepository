...
public class CodeFirstTest(IConfiguration configuration) : ISimpleDo
{
    public void Execute()
    {
        Test();
    ...
    private void Test()
    {
        ...
        var templateCreateTableSqlList = sqlGenerator.GetCreateTableSql<TestEntity>(false, tableName => "{$TableName$}");
