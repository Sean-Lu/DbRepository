    ...
    ) : ITestService
{
    ...
    public async Task<bool> AddAsync(IEnumerable<TestEntity> list)
    {
        ...
        //return await list.PagingExecuteAsync(200, async (pageNumber, models) => await testRepository.AddAsync(models));
    }
    ...
    public async Task<bool> AddOrUpdateAsync(IEnumerable<TestEntity> list)
    {
        ...
        //return await list.PagingExecuteAsync(200, async (pageNumber, models) => await testRepository.AddOrUpdateAsync(models));
    }
